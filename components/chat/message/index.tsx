...
import { BotsMetadataSheet } from '@/components/tools/bots-metadata-sheet';
                                        ...
                                        >
                                            {toolName === 'getWeather' ? (
                                                ...
                                                <LogsTool
                                                    ...
                                                    args={args}
                                                />
                                            ) : toolName === 'listToolsCards' ? (
                                                <div className="flex flex-row gap-2 items-center">
                                                    <TextShimmer className="font-medium">Preparing tools listing...</TextShimmer>
                                                    <div className="animate-spin">
                                                        <LoaderIcon />
                                                    </div>
                                                </div>
                                            ) : toolName === 'botsWithMetadata' ? (
                                                <div className="flex flex-row gap-2 items-center">
                                                    <TextShimmer className="font-medium">Fetching bot metadata...</TextShimmer>
                                                    <div className="animate-spin">
                                                        <LoaderIcon />
                                                    </div>
                                                </div>
                                        ...
                                        <div key={toolCallId}>
                                            {toolName === 'getWeather' ? (
                                                ...
                                                <div className="flex flex-col gap-4">
                                                    ...
                                                    <BotsMetadataSheet botsData={result.botsData} />
                                                </div>
                                            ) : (
                                                <ToolDetails
                                                    toolName={toolName}
